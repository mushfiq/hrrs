...
<?php $this->beginContent('/layouts/block', array('head' => 'Upload a CV')); ?>
   ...
   <p>
           <?php echo $form->labelEx($model,'Carrier Goal'); ?><br />
            <?php echo $form->textArea($model,'description',array('class'=>'wysiwyg')); ?>
            <?php echo $form->error($model,'description'); ?>
    </p>
   
   <p class='fileupload'>
       <?php echo $form->labelEx($model, 'CV'); ?> <br />
        <?php echo $form->fileField($model, 'pdf',array('id'=> 'fileupload','class'=>'file')); ?> 
