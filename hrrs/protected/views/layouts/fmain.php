...
<li class="active">
    <?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Add Company', 'url'=>array('/user/addcompany')),
...
<section id="fourcols">
<header class="mainheading">
<h2 class="introhead">What Makes Us Stand Out ?</h2>
</header>
<div class="clear"></div>
<div class="col">
...
<div id="credits">
2010 &copy; All Rights Reserved.  <a href="http://hrrs.com" title="HRRS">Website Template</a> by CSSHeaven </div>
</footer>
</footer>
</div><!-- page -->
